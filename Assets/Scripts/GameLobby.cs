...
public class GameLobby : MonoBehaviourPunCallbacks
{
	...
	void LobbyWindow(int index)
	{
		...
		GUILayout.FlexibleSpace();
		GUI.enabled = (PhotonNetwork.NetworkClientState == ClientState.JoinedLobby || PhotonNetwork.NetworkClientState == ClientState.Disconnected) && !joiningRoom; if (GUILayout.Button("Refresh", GUILayout.Width(100)))
		{
			if (PhotonNetwork.IsConnected)
		...
		GUILayout.EndHorizontal(); if (joiningRoom)
		{
